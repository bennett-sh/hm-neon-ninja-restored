...
async function createMainPatch() {
	...
	patch.getEntity('59e0361e55d60c9a').setPropertyValue('ConstantVector1D_07_Value', 90)
...
async function createUnplayablePatch() {
	...
	patch.getEntity('59e0361e55d60c9a').setPropertyValue('ConstantVector1D_07_Value', 1000)
